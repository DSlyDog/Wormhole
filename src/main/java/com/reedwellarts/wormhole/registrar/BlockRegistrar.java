...
public class BlockRegistrar {
    ...
    public static final Block WORMHOLE_PORTAL_CHARGER = register(
    ...
    public static BlockEntityType<WormholeChargerBlockEntity> WORMHOLE_CHARGER_BLOCK_ENTITY;
    ...
    public static void registerModBlocks() {
        ...
        ItemGroupEvents.modifyEntriesEvent(ItemGroups.BUILDING_BLOCKS).register(entries ->
            entries.add(WORMHOLE_PORTAL_CHARGER)
        );
        ...
        WORMHOLE_CHARGER_BLOCK_ENTITY = Registry.register(
                Registries.BLOCK_ENTITY_TYPE,
                Identifier.of(Wormhole.MOD_ID, "wormhole_portal_charger"),
                FabricBlockEntityTypeBuilder.create(
